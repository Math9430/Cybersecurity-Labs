# 📄 Log TCPDump – Incidente Brute Force su YummyRecipesForMe.com

> Log acquisiti durante l'analisi sandbox dell'incidente.  
> Mostrano le fasi DNS, HTTP e reindirizzamento dell’attacco.
---

## 🧪 Primo Accesso: yummyrecipesforme.com
...
## 🧪 Reindirizzamento: greatrecipesforme.com
...
## 🔍 Osservazioni
- Richieste DNS e connessioni HTTP indicano attività automatica malevola.
- Il sito iniziale era compromesso e fungeva da esca per il reindirizzamento.
- L'assenza di cifratura (HTTP invece di HTTPS) facilita la cattura e l’analisi del traffico.

---

💡 *Questi log saranno utilizzati nel report di analisi e nelle raccomandazioni di sicurezza successive.*
